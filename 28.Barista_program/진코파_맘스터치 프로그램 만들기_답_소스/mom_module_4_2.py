...
class _Object:
    ...
    def getState(self):
        return self.state
class Flour(_Object): pass
class Starch(_Object): pass
class Salt(_Object): pass
class Pepper(_Object): pass
class OnionPowder(_Object): pass
class GarlicPowder(_Object): pass
class BigBowl(_Object):
    def setState(self, state):
        self.state = state
class Egg(_Object): pass
class WideBowl(_Object):
    def setState(self, state):
        self.state = state
class ThighMeat(_Object):
    def setState(self, state):
        self.state = state
class CookingOil(_Object): pass
class DeepFryer(_Object):
    def setState(self, state):
        self.state = state
class Lettuce(_Object): pass
class HamburgerBunBottom(_Object):
    def setState(self, state):
        self.state = state
class HamburgerBunTop(_Object): pass
class Mayonnaise(_Object): pass
class Onion(_Object): pass
class Pickle(_Object): pass
